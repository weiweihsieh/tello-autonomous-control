...
def findMask(img): #red mask
  lr0 = np.array([0,150,0]) #HSV color space
...
def findMask1(img): #blue mask
  #lr0 = np.array([110,40,0])
  #ur0 = np.array([125,255,255])
  
  lr0 = np.array([78,43,46])
  ur0 = np.array([125,255,255])
...
def main():
    ...
    for frame in container.decode(video=0):
        ...
        print(tag)
        if tag == 0:
          red_mask = findMask(hsv_img) #red mask
        elif tag == 1:
          red_mask = findMask1(hsv_img) #blue mask
